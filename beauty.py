...
pygame.display.set_caption("Beauty")
...
background = pygame.image.load("beauty.png")  # Make sure you have an image file
...
locations = [
    {"name": "A", "event": "Beauty in low temperatures is true beauty", "x": 100, "y": 200},
    {"name": "B", "event": "flying emotions", "x": 200, "y": 300},
    {"name": "C", "event": "beauty of soul", "x": 300, "y": 450},
    {"name": "D", "event": "love and peace for humanity", "x": 200, "y": 500},
]
...
def game_loop():
    ...
    while running:
        ...
        draw_text("beauty - EXPLORE", 50, 50, NEON_BLUE)
